...
public class MenuLogic extends Menu {
	...
	public static boolean homeSubMenusAreDisplayed() {
		...
		Action moveMouseTo = builder.moveToElement(subHomeMenuTab).build();
				moveMouseTo.perform();
	...
	public static boolean fAQSubMenusAreDisplayed() {
		menusWithSubMenus.click();
		Actions builder = new Actions(Drivers.driver);
		Action moveMouseTo = builder.moveToElement(subFAQMenuTab).build();
				moveMouseTo.perform();
	...
	public static boolean newsSubMenusAreDisplayed() {
		menusWithSubMenus.click();
		Actions builder = new Actions(Drivers.driver);
		Action moveMouseTo = builder.moveToElement(subNewsMenuTab).build();
				moveMouseTo.perform();
